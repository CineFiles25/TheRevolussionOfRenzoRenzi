...
# ENTITIES
photo = URIRef(rrr + "photo_la_strada_woman")
...
# LOAD CSV
df = read_csv("../csv/photo_la_strada_woman.csv", keep_default_na=False, encoding="utf-8")
...
print("photo_la_strada_woman.ttl generated successfully!")
