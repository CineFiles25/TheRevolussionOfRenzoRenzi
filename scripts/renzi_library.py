...
for idx, row in renzo_renzi_library.iterrows():
    ...
    g.add((renzi_library, schema.openingHours, Literal(row["opening_hours"])))
    ...
    g.add((renzi_library, schema.description, Literal(row["structure_type"])))
    ...
    g.add((renzi_library, schema.description, Literal(row["audio_system"])))
    g.add((renzi_library, schema.description, Literal(row["video_system"])))
